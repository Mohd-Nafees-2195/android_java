...
public class AnnounceDocsAdapterByCoordinator extends FirebaseRecyclerAdapter<FileModel,AnnounceDocsAdapterByCoordinator.MyViewHolder> {
     ...
     * @param options
     */
    public AnnounceDocsAdapterByCoordinator(@NonNull FirebaseRecyclerOptions<FileModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull final AnnounceDocsAdapterByCoordinator.MyViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull final FileModel model) {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        holder.deleteButton.getContext().startActivity(new Intent(holder.deleteButton.getContext(),FetchAnnounceDocsByCoordinatorActivity.class));
                    }
                });
    ...
    @NonNull
    @Override
    public AnnounceDocsAdapterByCoordinator.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
