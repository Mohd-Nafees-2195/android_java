...
public class AnnounceDocsAdapterByGuide extends FirebaseRecyclerAdapter<FileModel,AnnounceDocsAdapterByGuide.MyViewHolder> {
     ...
     * @param options
     */
    public AnnounceDocsAdapterByGuide(@NonNull FirebaseRecyclerOptions<FileModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull final AnnounceDocsAdapterByGuide.MyViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull final FileModel model) {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        FirebaseDatabase.getInstance().getReference("UploadFilesByGuide").child(userId)
                                .child(getRef(position).getKey()).removeValue();
                        holder.deleteButton.getContext().startActivity(new Intent(holder.deleteButton.getContext(),FetchAnnounceDocsByGuideActivity.class));
                    }
                });
    ...
    @NonNull
    @Override
    public AnnounceDocsAdapterByGuide.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
