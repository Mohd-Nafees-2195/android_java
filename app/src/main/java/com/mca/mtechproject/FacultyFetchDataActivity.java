...
public class FacultyFetchDataActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private FacultyAdapter myAdapter;
    private ProgressBar progressBar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_faculty_fetch_data);
        ...
        FirebaseRecyclerOptions<FacultyData> options =
                new FirebaseRecyclerOptions.Builder<FacultyData>()
                        ...
                        .build();
        myAdapter = new FacultyAdapter(options);
    ...
    private void processsearch(String s)
    {
        FirebaseRecyclerOptions<FacultyData> options =
                new FirebaseRecyclerOptions.Builder<FacultyData>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("FacultyDetails").orderByChild("department").startAt(s).endAt(s+"~"), FacultyData.class)
                        .build();
