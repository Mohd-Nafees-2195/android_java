...
public class FacultyLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edPassword=findViewById(R.id.editTextLogFPassword);
        edEmail=findViewById(R.id.editTextLogFEmail);
        btnLogin=findViewById(R.id.buttonFLogin);
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FacultyLoginActivity.this, HomeActivity.class);
                startActivity(intent);
                finish();
            }
        });

        title.setText("Faculty Login");
        ...
        // check if faculty is already login then redirect it
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(email)) {
                    Toast.makeText(FacultyLoginActivity.this, "Please Enter Your Email", Toast.LENGTH_SHORT).show();
                    edEmail.setError("Email is required");
                    edEmail.requestFocus();
                } else if(!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                    Toast.makeText(FacultyLoginActivity.this, "Please Re-Enter Your Email", Toast.LENGTH_SHORT).show();
                    edEmail.setError("Invalid Email");
                    edEmail.requestFocus();
                } else if(TextUtils.isEmpty(password)){
                    Toast.makeText(FacultyLoginActivity.this, "Please Enter Your Password", Toast.LENGTH_SHORT).show();
        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(FacultyLoginActivity.this, "Done sent", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(FacultyLoginActivity.this, "Error Occurred", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                loadingBar.dismiss();
                Toast.makeText(FacultyLoginActivity.this, "Error Failed", Toast.LENGTH_LONG).show();
            }
        });
    }

    private void facultyLogin(String email,String password)
    {
        auth.signInWithEmailAndPassword(email,password)
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                progressBar.setVisibility(View.GONE);
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(FacultyLoginActivity.this, "Failed To Login! Try Again", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void checkUser(FirebaseUser user){
        ...
        reference.child(userId).get().addOnSuccessListener(new OnSuccessListener<DataSnapshot>() {
            ...
            public void onSuccess(DataSnapshot dataSnapshot) {
                ...
                if(studentData!=null){
                    Toast.makeText(FacultyLoginActivity.this, "Already Logged In", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(FacultyLoginActivity.this, FacultyHomeActivity.class);
                    startActivity(intent);
                    finish();
                }else{
                    Toast.makeText(FacultyLoginActivity.this, "Can not Login In This Role", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(FacultyLoginActivity.this, HomeActivity.class);
                    //auth.signOut();
                    startActivity(intent);
