...
public class StudentLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStudentLogin=findViewById(R.id.buttonSLogin);
        progressBar=findViewById(R.id.studentLoginProgressBar);
        ...
        // check if student is already login then redirect it
        ...
        btnStudentLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(email)) {
                    ...
                    Toast.makeText(StudentLoginActivity.this, "Please Re-Enter Your Email", Toast.LENGTH_SHORT).show();
                    edEmail.setError("Invalid Email");
                    edEmail.requestFocus();
                } else if(TextUtils.isEmpty(password)){
                    Toast.makeText(StudentLoginActivity.this, "Please Enter Your Password", Toast.LENGTH_SHORT).show();
                    edEmail.setError("Password is required");
                    edEmail.requestFocus();
                } else{
                    progressBar.setVisibility(View.VISIBLE);
                    studentLogin(email,password,user);
                }
            }
        });
        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    // if isSuccessful then message will be shown
                    // and you can change the password
                    Toast.makeText(StudentLoginActivity.this, "Check Your Email(Inbox/Spam)", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(StudentLoginActivity.this, "Error Occurred", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                loadingBar.dismiss();
                Toast.makeText(StudentLoginActivity.this, "Error Failed", Toast.LENGTH_LONG).show();
            }
        });
    }

    private void studentLogin(String email,String password,FirebaseUser user)
    {
        auth.signInWithEmailAndPassword(email,password)
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(StudentLoginActivity.this, "Failed To Login! Try Again", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void checkUser(FirebaseUser user){
        ...
        reference.child(userId).get().addOnSuccessListener(new OnSuccessListener<DataSnapshot>() {
            ...
            public void onSuccess(DataSnapshot dataSnapshot) {
                ...
                if(studentData!=null){
                    Toast.makeText(StudentLoginActivity.this, "Already Logged In", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(StudentLoginActivity.this, StudentHomeActivity.class);
                    startActivity(intent);
                    progressBar.setVisibility(View.INVISIBLE);
                    finish();
                }else{
                    Toast.makeText(StudentLoginActivity.this, "Can not Login In This Role", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(StudentLoginActivity.this, HomeActivity.class);
                    //auth.signOut();
                    startActivity(intent);
                    finish();
